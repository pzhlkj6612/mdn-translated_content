...
类型数组视图具有自描述性的名字，并且提供数据类型信息，例如`Int8`、`Uint32` 和 `Float64` 等等。如一个特定类型数组视图 `Uint8ClampedArray` ，意味着数据元素只包含 0 到 255 的整数值，通常用于 [Canvas 数据处理](/zh-CN/docs/Web/API/ImageData)。
