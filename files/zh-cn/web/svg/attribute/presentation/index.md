...
- {{SVGAttr('stop-color')}}
  - : Indicates what color to use at that gradient stop.
    _Value_: `currentColor`|[\<color>](/zh-CN/Web/SVG/Content_type#Color)|[\<icccolor>](/zh-CN/Web/SVG/Content_type#ICCColor)|`inherit`; _Animatable_: **Yes**
- {{SVGAttr('stop-opacity')}}
  - : Defines the opacity of a given gradient stop.
    _Value_: [\<opacity-value>](/zh-CN/Web/SVG/Content_type#Opacity_value)|`inherit`; _Animatable_: **Yes**
- {{SVGAttr('stroke')}}
...
- {{SVGAttr('stroke-dashoffset')}}
  - : Defines an offset on the rendering of the associated dash array.
    _Value_: [\<percentage>](/zh-CN/Web/SVG/Content_type#Percentage)|[\<length>](/zh-CN/Web/SVG/Content_type#Length); _Animatable_: **Yes**
...
- **{{SVGAttr('stroke-miterlimit')}}**
  - : Defines a limit on the ratio of the miter length to the {{ SVGAttr("stroke-width") }} used to draw a miter join.
    _Value_: [\<number>](/zh-CN/Web/SVG/Content_type#Number); _Animatable_: **Yes**
- **{{SVGAttr('stroke-opacity')}}**
  - : Defines the opacity of the stroke of a shape.
    _Value_: [\<opacity-value>](/zh-CN/Web/SVG/Content_type#Opacity_value)|[\<percentage>](/zh-CN/docs/Web/SVG/Content_type#Paint); _Animatable_: **Yes**
...
- **{{SVGAttr('word-spacing')}}**
  - : Specifies spacing behavior between words.
    _Value_: [\<length>](/zh-CN/Web/SVG/Content_type#Length)|**`inherit`**; _Animatable_: **Yes**
