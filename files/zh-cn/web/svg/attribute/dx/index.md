...
对于{{SVGElement("text")}}、{{SVGElement("tspan")}}、{{SVGElement("tref")}}和{{SVGElement("altGlyph")}}元素，由于这些元素允许设置[\<list-of-length>](/zh-CN/Web/SVG/Content_type#List-of-Ts)，所以更复杂。

如果只提供了一个[\<length>](/zh-CN/Web/SVG/Content_type#Length)，当前文本位置会沿着坐标系内 x 轴方向偏移[\<length>](/zh-CN/Web/SVG/Content_type#Length) 。

如果提供了一个由逗号或者空格分隔的[\<length>](/zh-CN/Web/SVG/Content_type#Length)列表，列表中的值将会表示前 n 个字符沿 x 轴方向偏移的增量。因此，当前文本位置也因为绘制当前{{SVGElement("text")}}元素而沿 x 轴方向偏移。

如果在[\<length>](/zh-CN/Web/SVG/Content_type#Length)列表中有更多的字符，那么对于每个字符，都有
...
| 分类     | 无                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 数值类型 | [\<number>](/zh-CN/Web/SVG/Content_type#Number) \| [T<.2Fvar>s">\<list-of-length>](/zh-CN/Web/SVG/Content_type#List-of-<var>T<.2Fvar>s)                                                                                                                                                                                                                                                                                                                                                                                                              |
| 可变     | 是                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
